...
| `FND-05` - Introduce a minimal audit-event store | 1. Foundation and safety | Not recorded | `FND-03`, `FND-04` | `FND-09`, `FND-14`, `STB-08`, `REC-05`, `REC-07`, `REC-11`, `NUT-01`, `NUT-09`, `NUT-17`, `PLAN-06`, `DEP-08`, `DEP-09` | `DEC-009` (Constrained), `DEC-010` (Related), `DEC-013` (Unblocked) | NUT-09 catalogue moderation records (line 1474) |
| `FND-06` - Establish shared nutrient and measurement definitions | 1. Foundation and safety | Complete (2026-07-31) | - | `STB-04`, `STB-06`, `REC-02`, `REC-08`, `NUT-04`, `NUT-05`, `NUT-14`, `PLAN-10` | `DEC-003` (Unblocked), `DEC-004` (Unblocked), `DEC-017` (Unblocked) | Recipe ingredient line (line 440), Shared catalogue item and version (line 639), Catalogue package and serving structure (line 697), Catalogue nutrition observation and normalized fact (line 750), Measurement unit (line 992), Current rules and constraints (line 1139), Nutrition schema and units (line 1297) |
...
| `STB-04` - Converge ingredient write validation | 2. Existing-feature stabilisation | Complete (2026-08-13) | `STB-01`, `FND-06` | `STB-05` | `DEC-003` (Constrained), `DEC-017` (Constrained) | Nutrition dataset (line 1040), Nutrition schema and units (line 1297) |
| `STB-05` - Preserve explicit zero nutrition values | 2. Existing-feature stabilisation | Complete (2026-08-13) | `STB-04` | `STB-06` | - | Nutrition schema and units (line 1297) |
| `STB-06` - Stabilize current energy and protein handling | 2. Existing-feature stabilisation | Complete (2026-08-13) | `FND-06`, `STB-05` | - | `DEC-003` (Unblocked), `DEC-004` (Unblocked) | Nutrition dataset (line 1040) |
| `STB-07` - Isolate and harden OpenFoodFacts access | 2. Existing-feature stabilisation | Complete (2026-08-13) | `FND-09` | `STB-08`, `NUT-06` | - | Current rules and constraints (line 1139) |
| `STB-08` - Enforce machine-imported barcode provenance | 2. Existing-feature stabilisation | Complete (2026-08-13) | `STB-07`, `FND-05` | `STB-09`, `NUT-02` | - | Barcode and OpenFoodFacts product data (line 1079) |
...
| `REC-04` - Build the draft recipe editor | 3. Core recipe functionality | Complete (2026-08-15) | `REC-01`, `REC-02`, `REC-03` | `REC-05`, `REC-15`, `UX-03` | - | Recipe draft (line 186), Recipe imports (line 1377) |
| `REC-05` - Finalize and publish a recipe draft | 3. Core recipe functionality | Complete (2026-08-15) | `REC-04`, `FND-05` | `REC-06`, `REC-07`, `NUT-15`, `PLAN-01` | - | Finalized recipe version (line 272), Recipe imports (line 1377) |
...
| `REC-15` - Import pasted recipe text into a draft | 3. Core recipe functionality | Complete (2026-08-27) | `REC-04`, `FND-09`, `DEP-04`, `DEP-05` | `REC-16`, `REC-17`, `NUT-17`, `UX-06` | `DEC-005` (Constrained), `DEC-007` (Constrained) | Recipe imports (line 1377) |
| `REC-16` - Import a webpage recipe into a draft | 3. Core recipe functionality | Complete (2026-08-27) | `REC-15`, `FND-09`, `DEP-04`, `DEP-05` | - | `DEC-005` (Unblocked), `DEC-007` (Unblocked) | Recipe imports (line 1377) |
...
| `NUT-01` - Add shared catalogue identity and provenance schema | 4. Nutrition and food matching | Complete (2026-08-29) | `FND-02`, `FND-03`, `FND-05` | `NUT-02`, `NUT-04`, `NUT-05` | - | Shared catalogue item and version (line 639) |
| `NUT-02` - Backfill existing ingredients into catalogue candidates | 4. Nutrition and food matching | Complete (2026-08-31) | `NUT-01`, `STB-08` | `NUT-03` | `DEC-011` (Constrained) | Shared catalogue item and version (line 639), Shared barcode import and reuse (line 827), Legacy ingredient catalogue mapping (line 878) |
| `NUT-03` - Cut reads over to the shared catalogue | 4. Nutrition and food matching | Complete (2026-08-31) | `NUT-02`, `FND-03` | `NUT-06`, `NUT-07`, `NUT-08`, `UX-01` | `DEC-011` (Related) | Recipe ingredient catalogue match (line 501), Shared catalogue item and version (line 639), Shared barcode import and reuse (line 827), Legacy ingredient catalogue mapping (line 878), Pending manual catalogue submission (line 945) |
| `NUT-04` - Model package and serving structure | 4. Nutrition and food matching | Complete (2026-09-01) | `NUT-01`, `FND-06` | `NUT-06`, `NUT-08` | `DEC-017` (Constrained) | Catalogue nutrition observation and normalized fact (line 750), Shared barcode import and reuse (line 827), Pending manual catalogue submission (line 945) |
| `NUT-05` - Normalize catalogue nutrition and provenance | 4. Nutrition and food matching | Complete (2026-09-01) | `NUT-01`, `FND-06` | `NUT-06`, `NUT-08`, `NUT-15`, `PLAN-04` | `DEC-003` (Unblocked), `DEC-004` (Related) | Shared catalogue item and version (line 639), Catalogue nutrition observation and normalized fact (line 750), Pending manual catalogue submission (line 945) |
| `NUT-06` - Import barcodes into the shared catalogue | 4. Nutrition and food matching | Complete (2026-09-01) | `STB-07`, `STB-09`, `NUT-03`, `NUT-04`, `NUT-05` | `NUT-11` | - | Catalogue package and serving structure (line 697), Shared barcode import and reuse (line 827) |
| `NUT-07` - Add catalogue search and manual match selection | 4. Nutrition and food matching | Complete (2026-09-08) | `REC-02`, `NUT-03` | `NUT-12`, `NUT-14` | `DEC-001` (Related) | Recipe ingredient catalogue match (line 501) |
| `NUT-08` - Add pending manual catalogue submissions | 4. Nutrition and food matching | Complete (2026-09-08) | `NUT-03`, `NUT-04`, `NUT-05`, `DEC-011` | `NUT-09` | `DEC-011` (Unblocked) | Legacy ingredient catalogue mapping (line 878) |
...
| `DEC-005` - Recipe-import providers and formats | Decided | `FND-09` (Related), `REC-15` (Constrained), `REC-16` (Unblocked), `REC-17` (Constrained), `UX-06` (Related), `DEP-02` (Unblocked), `DEP-03` (Constrained) | Recipe imports (line 1377) |
| `DEC-006` - OCR providers and formats | Decided | `FND-09` (Constrained), `REC-17` (Unblocked), `UX-06` (Constrained), `DEP-02` (Unblocked), `DEP-03` (Constrained), `DEP-04` (Related), `DEP-05` (Related) | Recipe imports (line 1377) |
| `DEC-007` - Import and OCR extraction-quality thresholds | Decided | `FND-09` (Related), `REC-15` (Constrained), `REC-16` (Unblocked), `REC-17` (Unblocked), `UX-06` (Constrained), `DEP-04` (Related), `DEP-05` (Related) | Recipe imports (line 1377) |
...
| `DEC-011` - Manual-food de-duplication and merge rules | Decided | `FND-02` (Related), `NUT-02` (Constrained), `NUT-03` (Related), `NUT-08` (Unblocked), `NUT-09` (Constrained) | Legacy ingredient catalogue mapping (line 878), NUT-09 catalogue moderation records (line 1474) |
...
| Concept: Recipe ingredient catalogue match | 501-545 | `NUT-07`, `REC-07`, `NUT-03` | - |
| Concept: Recipe instruction section | 546-566 | - | - |
| Concept: Recipe instruction step | 567-596 | - | - |
| Concept: Ingredient | 597-638 | - | - |
| Concept: Shared catalogue item and version | 639-696 | `NUT-01`, `FND-06`, `NUT-05`, `NUT-02`, `NUT-03` | - |
| Concept: Catalogue package and serving structure | 697-749 | `FND-06`, `NUT-06` | - |
| Concept: Catalogue nutrition observation and normalized fact | 750-826 | `NUT-05`, `FND-06`, `NUT-04` | `DEC-003`, `DEC-004` |
| Concept: Shared barcode import and reuse | 827-877 | `NUT-06`, `NUT-03`, `NUT-02`, `NUT-04` | - |
| Concept: Legacy ingredient catalogue mapping | 878-944 | `NUT-02`, `NUT-03`, `NUT-08`, `NUT-09` | `DEC-011` |
| Concept: Pending manual catalogue submission | 945-991 | `NUT-04`, `NUT-05`, `NUT-03` | - |
| Concept: Measurement unit | 992-1020 | `FND-06` | - |
| Concept: Nutrient definition | 1021-1039 | - | `DEC-003`, `DEC-004` |
| Concept: Nutrition dataset | 1040-1078 | `STB-04`, `STB-06` | `DEC-004` |
| Concept: Barcode and OpenFoodFacts product data | 1079-1098 | `STB-08` | - |
| Current relationships | 1099-1138 | - | - |
| Current rules and constraints | 1139-1243 | `FND-06`, `STB-07` | `DEC-003`, `DEC-004` |
| Unclear or inconsistent concepts | 1244-1245 | - | - |
| Concept: Meaning of ingredient | 1246-1252 | - | - |
| Concept: Meaning of quantity | 1253-1265 | - | - |
| Concept: Serving terminology | 1266-1277 | - | - |
| Concept: Food identity and barcode uniqueness | 1278-1284 | - | - |
| Concept: Nutrition provenance and accuracy | 1285-1296 | - | - |
| Concept: Nutrition schema and units | 1297-1314 | `STB-04`, `FND-06`, `STB-05` | `DEC-003` |
| Concept: Keywords and categories | 1315-1322 | - | - |
| Concept: Original user input | 1323-1335 | - | - |
| Concept: Public recipe metadata | 1336-1364 | - | - |
| Concepts not yet represented | 1365-1376 | - | - |
| Concept: Recipe imports | 1377-1455 | `REC-15`, `REC-16`, `REC-04`, `REC-05` | `DEC-006`, `DEC-005`, `DEC-007` |
| Questions requiring owner input | 1456-1473 | - | - |
| NUT-09 catalogue moderation records | 1474-1508 | `NUT-09`, `FND-05` | `DEC-011` |
| NUT-10 catalogue correction proposal | 1509-1532 | `NUT-10` | - |
