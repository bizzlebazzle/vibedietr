...
| `STB-04` - Converge ingredient write validation | 2. Existing-feature stabilisation | Complete (2026-08-13) | `STB-01`, `FND-06` | `STB-05` | `DEC-003` (Constrained), `DEC-017` (Constrained) | Nutrition dataset (line 1077), Nutrition schema and units (line 1460) |
| `STB-05` - Preserve explicit zero nutrition values | 2. Existing-feature stabilisation | Complete (2026-08-13) | `STB-04` | `STB-06` | - | Nutrition schema and units (line 1460) |
...
| `STB-07` - Isolate and harden OpenFoodFacts access | 2. Existing-feature stabilisation | Complete (2026-08-13) | `FND-09` | `STB-08`, `NUT-06` | - | Current rules and constraints (line 1196) |
...
| `REC-04` - Build the draft recipe editor | 3. Core recipe functionality | Complete (2026-08-15) | `REC-01`, `REC-02`, `REC-03` | `REC-05`, `REC-15`, `UX-03` | - | Recipe draft (line 186), Recipe imports (line 1579) |
| `REC-05` - Finalize and publish a recipe draft | 3. Core recipe functionality | Complete (2026-08-15) | `REC-04`, `FND-05` | `REC-06`, `REC-07`, `NUT-15`, `PLAN-01` | - | Finalized recipe version (line 272), Recipe imports (line 1579) |
...
| `REC-15` - Import pasted recipe text into a draft | 3. Core recipe functionality | Complete (2026-08-27) | `REC-04`, `FND-09`, `DEP-04`, `DEP-05` | `REC-16`, `REC-17`, `NUT-17`, `UX-06` | `DEC-005` (Constrained), `DEC-007` (Constrained) | Recipe imports (line 1579) |
| `REC-16` - Import a webpage recipe into a draft | 3. Core recipe functionality | Complete (2026-08-27) | `REC-15`, `FND-09`, `DEP-04`, `DEP-05` | - | `DEC-005` (Unblocked), `DEC-007` (Unblocked) | Recipe imports (line 1579) |
...
| `NUT-10` - Add catalogue correction proposals | 4. Nutrition and food matching | Complete (2026-09-09) | `NUT-09` | `NUT-18` | `DEC-009` (Constrained), `DEC-010` (Constrained), `DEC-013` (Constrained) | NUT-10 catalogue correction proposal (line 1711) |
...
| `NUT-15` - Calculate recipe nutrition estimates | 4. Nutrition and food matching | Complete (2026-09-11) | `REC-05`, `NUT-05`, `NUT-12`, `NUT-14` | `NUT-16`, `NUT-17`, `PLAN-03` | `DEC-001` (Constrained), `DEC-003` (Constrained) | Current rules and constraints (line 1196), Recipe nutrition sources and overrides (line 1528) |
...
| `NUT-17` - Add recipe nutrition source precedence and overrides | 4. Nutrition and food matching | Complete (2026-09-12) | `NUT-15`, `FND-05`, `REC-15` | `NUT-18`, `PLAN-06` | `DEC-003` (Constrained) | Current rules and constraints (line 1196), Recipe nutrition sources and overrides (line 1528) |
| `NUT-18` - Recalculate affected recipes after catalogue approval | 4. Nutrition and food matching | Complete (2026-09-12) | `NUT-10` or `NUT-11`, `NUT-17`, `FND-09`, `DEP-04`, `DEP-05` | - | - | Recipe nutrition sources and overrides (line 1528) |
...
| `PLAN-03` - Add recipe entries with version snapshots | 5. Meal and diet planning | Complete (2026-09-12) | `PLAN-02`, `REC-07`, `NUT-15` | `PLAN-05`, `PLAN-07`, `PLAN-08`, `UX-06` | - | Current rules and constraints (line 1196) |
| `PLAN-04` - Add catalogue and one-off plan entries | 5. Meal and diet planning | Complete (2026-09-17) | `PLAN-02`, `NUT-05` | `PLAN-05` | - | - |
| `PLAN-05` - Record planned versus consumed state | 5. Meal and diet planning | Complete (2026-09-19) | `PLAN-03`, `PLAN-04` | `PLAN-06`, `UX-05` | `DEC-019` (Unblocked) | Current rules and constraints (line 1196) |
| `PLAN-06` - Snapshot nutrition at consumption time | 5. Meal and diet planning | Complete (2026-09-20) | `PLAN-05`, `NUT-17`, `FND-05` | `PLAN-12` | `DEC-019` (Constrained) | Current rules and constraints (line 1196) |
...
| `DEC-003` - Nutrient storage precision | Decided | `FND-06` (Unblocked), `STB-04` (Constrained), `STB-06` (Unblocked), `NUT-05` (Unblocked), `NUT-15` (Constrained), `NUT-17` (Constrained) | Catalogue nutrition observation and normalized fact (line 775), Nutrient definition (line 1058), Current rules and constraints (line 1196), Nutrition schema and units (line 1460) |
| `DEC-004` - Nutrient display precision | Decided | `FND-06` (Unblocked), `STB-06` (Unblocked), `NUT-05` (Related), `NUT-16` (Constrained), `PLAN-12` (Constrained), `UX-04` (Constrained) | Catalogue nutrition observation and normalized fact (line 775), Nutrient definition (line 1058), Nutrition dataset (line 1077), Current rules and constraints (line 1196) |
| `DEC-005` - Recipe-import providers and formats | Decided | `FND-09` (Related), `REC-15` (Constrained), `REC-16` (Unblocked), `REC-17` (Constrained), `UX-06` (Related), `DEP-02` (Unblocked), `DEP-03` (Constrained) | Recipe imports (line 1579) |
| `DEC-006` - OCR providers and formats | Decided | `FND-09` (Constrained), `REC-17` (Unblocked), `UX-06` (Constrained), `DEP-02` (Unblocked), `DEP-03` (Constrained), `DEP-04` (Related), `DEP-05` (Related) | Recipe imports (line 1579) |
| `DEC-007` - Import and OCR extraction-quality thresholds | Decided | `FND-09` (Related), `REC-15` (Constrained), `REC-16` (Unblocked), `REC-17` (Unblocked), `UX-06` (Constrained), `DEP-04` (Related), `DEP-05` (Related) | Recipe imports (line 1579) |
...
| `DEC-011` - Manual-food de-duplication and merge rules | Decided | `FND-02` (Related), `NUT-02` (Constrained), `NUT-03` (Related), `NUT-08` (Unblocked), `NUT-09` (Constrained) | Legacy ingredient catalogue mapping (line 903), NUT-09 catalogue moderation records (line 1676) |
...
| `DEC-019` - Diary consumption time and correction history | Decided | `PLAN-05` (Unblocked), `PLAN-06` (Constrained), `PLAN-12` (Constrained), `UX-05` (Constrained) | Current rules and constraints (line 1196) |
...
| Current relationships | 1136-1195 | - | - |
| Current rules and constraints | 1196-1406 | `PLAN-03`, `NUT-17`, `NUT-15`, `PLAN-05`, `PLAN-06`, `FND-06`, `STB-07` | `DEC-019`, `DEC-003`, `DEC-004` |
| Unclear or inconsistent concepts | 1407-1408 | - | - |
| Concept: Meaning of ingredient | 1409-1415 | - | - |
| Concept: Meaning of quantity | 1416-1428 | - | - |
| Concept: Serving terminology | 1429-1440 | - | - |
| Concept: Food identity and barcode uniqueness | 1441-1447 | - | - |
| Concept: Nutrition provenance and accuracy | 1448-1459 | - | - |
| Concept: Nutrition schema and units | 1460-1477 | `STB-04`, `FND-06`, `STB-05` | `DEC-003` |
| Concept: Keywords and categories | 1478-1485 | - | - |
| Concept: Original user input | 1486-1498 | - | - |
| Concept: Public recipe metadata | 1499-1527 | - | - |
| Concept: Recipe nutrition sources and overrides | 1528-1568 | `NUT-15`, `FND-05`, `NUT-18`, `NUT-17` | - |
| Concepts not yet represented | 1569-1578 | - | - |
| Concept: Recipe imports | 1579-1657 | `REC-15`, `REC-16`, `REC-04`, `REC-05` | `DEC-006`, `DEC-005`, `DEC-007` |
| Questions requiring owner input | 1658-1675 | - | - |
| NUT-09 catalogue moderation records | 1676-1710 | `NUT-09`, `FND-05` | `DEC-011` |
| NUT-10 catalogue correction proposal | 1711-1734 | `NUT-10` | - |
