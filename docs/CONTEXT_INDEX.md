...
| `STB-04` - Converge ingredient write validation | 2. Existing-feature stabilisation | Complete (2026-08-13) | `STB-01`, `FND-06` | `STB-05` | `DEC-003` (Constrained), `DEC-017` (Constrained) | Nutrition dataset (line 1077), Nutrition schema and units (line 1484) |
| `STB-05` - Preserve explicit zero nutrition values | 2. Existing-feature stabilisation | Complete (2026-08-13) | `STB-04` | `STB-06` | - | Nutrition schema and units (line 1484) |
...
| `REC-04` - Build the draft recipe editor | 3. Core recipe functionality | Complete (2026-08-15) | `REC-01`, `REC-02`, `REC-03` | `REC-05`, `REC-15`, `UX-03` | - | Recipe draft (line 186), Recipe imports (line 1603) |
| `REC-05` - Finalize and publish a recipe draft | 3. Core recipe functionality | Complete (2026-08-15) | `REC-04`, `FND-05` | `REC-06`, `REC-07`, `NUT-15`, `PLAN-01` | - | Finalized recipe version (line 272), Recipe imports (line 1603) |
...
| `REC-15` - Import pasted recipe text into a draft | 3. Core recipe functionality | Complete (2026-08-27) | `REC-04`, `FND-09`, `DEP-04`, `DEP-05` | `REC-16`, `REC-17`, `NUT-17`, `UX-06` | `DEC-005` (Constrained), `DEC-007` (Constrained) | Recipe imports (line 1603) |
| `REC-16` - Import a webpage recipe into a draft | 3. Core recipe functionality | Complete (2026-08-27) | `REC-15`, `FND-09`, `DEP-04`, `DEP-05` | - | `DEC-005` (Unblocked), `DEC-007` (Unblocked) | Recipe imports (line 1603) |
...
| `NUT-10` - Add catalogue correction proposals | 4. Nutrition and food matching | Complete (2026-09-09) | `NUT-09` | `NUT-18` | `DEC-009` (Constrained), `DEC-010` (Constrained), `DEC-013` (Constrained) | NUT-10 catalogue correction proposal (line 1735) |
...
| `NUT-15` - Calculate recipe nutrition estimates | 4. Nutrition and food matching | Complete (2026-09-11) | `REC-05`, `NUT-05`, `NUT-12`, `NUT-14` | `NUT-16`, `NUT-17`, `PLAN-03` | `DEC-001` (Constrained), `DEC-003` (Constrained) | Current rules and constraints (line 1198), Recipe nutrition sources and overrides (line 1552) |
...
| `NUT-17` - Add recipe nutrition source precedence and overrides | 4. Nutrition and food matching | Complete (2026-09-12) | `NUT-15`, `FND-05`, `REC-15` | `NUT-18`, `PLAN-06` | `DEC-003` (Constrained) | Current rules and constraints (line 1198), Recipe nutrition sources and overrides (line 1552) |
| `NUT-18` - Recalculate affected recipes after catalogue approval | 4. Nutrition and food matching | Complete (2026-09-12) | `NUT-10` or `NUT-11`, `NUT-17`, `FND-09`, `DEP-04`, `DEP-05` | - | - | Recipe nutrition sources and overrides (line 1552) |
...
| `DEC-005` - Recipe-import providers and formats | Decided | `FND-09` (Related), `REC-15` (Constrained), `REC-16` (Unblocked), `REC-17` (Constrained), `UX-06` (Related), `DEP-02` (Unblocked), `DEP-03` (Constrained) | Recipe imports (line 1603) |
| `DEC-006` - OCR providers and formats | Decided | `FND-09` (Constrained), `REC-17` (Unblocked), `UX-06` (Constrained), `DEP-02` (Unblocked), `DEP-03` (Constrained), `DEP-04` (Related), `DEP-05` (Related) | Recipe imports (line 1603) |
| `DEC-007` - Import and OCR extraction-quality thresholds | Decided | `FND-09` (Related), `REC-15` (Constrained), `REC-16` (Unblocked), `REC-17` (Unblocked), `UX-06` (Constrained), `DEP-04` (Related), `DEP-05` (Related) | Recipe imports (line 1603) |
...
| `DEC-011` - Manual-food de-duplication and merge rules | Decided | `FND-02` (Related), `NUT-02` (Constrained), `NUT-03` (Related), `NUT-08` (Unblocked), `NUT-09` (Constrained) | Legacy ingredient catalogue mapping (line 903), NUT-09 catalogue moderation records (line 1700) |
...
| Current rules and constraints | 1198-1430 | `PLAN-03`, `NUT-17`, `NUT-15`, `PLAN-05`, `PLAN-06`, `FND-06`, `STB-07` | `DEC-014`, `DEC-019`, `DEC-003`, `DEC-004` |
| Unclear or inconsistent concepts | 1431-1432 | - | - |
| Concept: Meaning of ingredient | 1433-1439 | - | - |
| Concept: Meaning of quantity | 1440-1452 | - | - |
| Concept: Serving terminology | 1453-1464 | - | - |
| Concept: Food identity and barcode uniqueness | 1465-1471 | - | - |
| Concept: Nutrition provenance and accuracy | 1472-1483 | - | - |
| Concept: Nutrition schema and units | 1484-1501 | `STB-04`, `FND-06`, `STB-05` | `DEC-003` |
| Concept: Keywords and categories | 1502-1509 | - | - |
| Concept: Original user input | 1510-1522 | - | - |
| Concept: Public recipe metadata | 1523-1551 | - | - |
| Concept: Recipe nutrition sources and overrides | 1552-1592 | `NUT-15`, `FND-05`, `NUT-18`, `NUT-17` | - |
| Concepts not yet represented | 1593-1602 | - | - |
| Concept: Recipe imports | 1603-1681 | `REC-15`, `REC-16`, `REC-04`, `REC-05` | `DEC-006`, `DEC-005`, `DEC-007` |
| Questions requiring owner input | 1682-1699 | - | - |
| NUT-09 catalogue moderation records | 1700-1734 | `NUT-09`, `FND-05` | `DEC-011` |
| NUT-10 catalogue correction proposal | 1735-1758 | `NUT-10` | - |
