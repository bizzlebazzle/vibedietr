...
| `STB-04` - Converge ingredient write validation | 2. Existing-feature stabilisation | Complete (2026-08-13) | `STB-01`, `FND-06` | `STB-05` | `DEC-003` (Constrained), `DEC-017` (Constrained) | Nutrition dataset (line 1077), Nutrition schema and units (line 1389) |
| `STB-05` - Preserve explicit zero nutrition values | 2. Existing-feature stabilisation | Complete (2026-08-13) | `STB-04` | `STB-06` | - | Nutrition schema and units (line 1389) |
...
| `STB-07` - Isolate and harden OpenFoodFacts access | 2. Existing-feature stabilisation | Complete (2026-08-13) | `FND-09` | `STB-08`, `NUT-06` | - | Current rules and constraints (line 1183) |
...
| `REC-04` - Build the draft recipe editor | 3. Core recipe functionality | Complete (2026-08-15) | `REC-01`, `REC-02`, `REC-03` | `REC-05`, `REC-15`, `UX-03` | - | Recipe draft (line 186), Recipe imports (line 1508) |
| `REC-05` - Finalize and publish a recipe draft | 3. Core recipe functionality | Complete (2026-08-15) | `REC-04`, `FND-05` | `REC-06`, `REC-07`, `NUT-15`, `PLAN-01` | - | Finalized recipe version (line 272), Recipe imports (line 1508) |
...
| `REC-15` - Import pasted recipe text into a draft | 3. Core recipe functionality | Complete (2026-08-27) | `REC-04`, `FND-09`, `DEP-04`, `DEP-05` | `REC-16`, `REC-17`, `NUT-17`, `UX-06` | `DEC-005` (Constrained), `DEC-007` (Constrained) | Recipe imports (line 1508) |
| `REC-16` - Import a webpage recipe into a draft | 3. Core recipe functionality | Complete (2026-08-27) | `REC-15`, `FND-09`, `DEP-04`, `DEP-05` | - | `DEC-005` (Unblocked), `DEC-007` (Unblocked) | Recipe imports (line 1508) |
...
| `NUT-10` - Add catalogue correction proposals | 4. Nutrition and food matching | Complete (2026-09-09) | `NUT-09` | `NUT-18` | `DEC-009` (Constrained), `DEC-010` (Constrained), `DEC-013` (Constrained) | NUT-10 catalogue correction proposal (line 1640) |
...
| `NUT-15` - Calculate recipe nutrition estimates | 4. Nutrition and food matching | Complete (2026-09-11) | `REC-05`, `NUT-05`, `NUT-12`, `NUT-14` | `NUT-16`, `NUT-17`, `PLAN-03` | `DEC-001` (Constrained), `DEC-003` (Constrained) | Current rules and constraints (line 1183), Recipe nutrition sources and overrides (line 1457) |
...
| `NUT-17` - Add recipe nutrition source precedence and overrides | 4. Nutrition and food matching | Complete (2026-09-12) | `NUT-15`, `FND-05`, `REC-15` | `NUT-18`, `PLAN-06` | `DEC-003` (Constrained) | Current rules and constraints (line 1183), Recipe nutrition sources and overrides (line 1457) |
| `NUT-18` - Recalculate affected recipes after catalogue approval | 4. Nutrition and food matching | Complete (2026-09-12) | `NUT-10` or `NUT-11`, `NUT-17`, `FND-09`, `DEP-04`, `DEP-05` | - | - | Recipe nutrition sources and overrides (line 1457) |
...
| `PLAN-03` - Add recipe entries with version snapshots | 5. Meal and diet planning | Complete (2026-09-12) | `PLAN-02`, `REC-07`, `NUT-15` | `PLAN-05`, `PLAN-07`, `PLAN-08`, `UX-06` | - | Current rules and constraints (line 1183) |
...
| `DEC-003` - Nutrient storage precision | Decided | `FND-06` (Unblocked), `STB-04` (Constrained), `STB-06` (Unblocked), `NUT-05` (Unblocked), `NUT-15` (Constrained), `NUT-17` (Constrained) | Catalogue nutrition observation and normalized fact (line 775), Nutrient definition (line 1058), Current rules and constraints (line 1183), Nutrition schema and units (line 1389) |
| `DEC-004` - Nutrient display precision | Decided | `FND-06` (Unblocked), `STB-06` (Unblocked), `NUT-05` (Related), `NUT-16` (Constrained), `PLAN-12` (Constrained), `UX-04` (Constrained) | Catalogue nutrition observation and normalized fact (line 775), Nutrient definition (line 1058), Nutrition dataset (line 1077), Current rules and constraints (line 1183) |
| `DEC-005` - Recipe-import providers and formats | Decided | `FND-09` (Related), `REC-15` (Constrained), `REC-16` (Unblocked), `REC-17` (Constrained), `UX-06` (Related), `DEP-02` (Unblocked), `DEP-03` (Constrained) | Recipe imports (line 1508) |
| `DEC-006` - OCR providers and formats | Decided | `FND-09` (Constrained), `REC-17` (Unblocked), `UX-06` (Constrained), `DEP-02` (Unblocked), `DEP-03` (Constrained), `DEP-04` (Related), `DEP-05` (Related) | Recipe imports (line 1508) |
| `DEC-007` - Import and OCR extraction-quality thresholds | Decided | `FND-09` (Related), `REC-15` (Constrained), `REC-16` (Unblocked), `REC-17` (Unblocked), `UX-06` (Constrained), `DEP-04` (Related), `DEP-05` (Related) | Recipe imports (line 1508) |
...
| `DEC-011` - Manual-food de-duplication and merge rules | Decided | `FND-02` (Related), `NUT-02` (Constrained), `NUT-03` (Related), `NUT-08` (Unblocked), `NUT-09` (Constrained) | Legacy ingredient catalogue mapping (line 903), NUT-09 catalogue moderation records (line 1605) |
...
| Current relationships | 1136-1182 | - | - |
| Current rules and constraints | 1183-1335 | `PLAN-03`, `NUT-17`, `NUT-15`, `FND-06`, `STB-07` | `DEC-003`, `DEC-004` |
| Unclear or inconsistent concepts | 1336-1337 | - | - |
| Concept: Meaning of ingredient | 1338-1344 | - | - |
| Concept: Meaning of quantity | 1345-1357 | - | - |
| Concept: Serving terminology | 1358-1369 | - | - |
| Concept: Food identity and barcode uniqueness | 1370-1376 | - | - |
| Concept: Nutrition provenance and accuracy | 1377-1388 | - | - |
| Concept: Nutrition schema and units | 1389-1406 | `STB-04`, `FND-06`, `STB-05` | `DEC-003` |
| Concept: Keywords and categories | 1407-1414 | - | - |
| Concept: Original user input | 1415-1427 | - | - |
| Concept: Public recipe metadata | 1428-1456 | - | - |
| Concept: Recipe nutrition sources and overrides | 1457-1497 | `NUT-15`, `FND-05`, `NUT-18`, `NUT-17` | - |
| Concepts not yet represented | 1498-1507 | - | - |
| Concept: Recipe imports | 1508-1586 | `REC-15`, `REC-16`, `REC-04`, `REC-05` | `DEC-006`, `DEC-005`, `DEC-007` |
| Questions requiring owner input | 1587-1604 | - | - |
| NUT-09 catalogue moderation records | 1605-1639 | `NUT-09`, `FND-05` | `DEC-011` |
| NUT-10 catalogue correction proposal | 1640-1663 | `NUT-10` | - |
