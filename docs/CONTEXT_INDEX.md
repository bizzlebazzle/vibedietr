...
| `STB-04` - Converge ingredient write validation | 2. Existing-feature stabilisation | Complete (2026-08-13) | `STB-01`, `FND-06` | `STB-05` | `DEC-003` (Constrained), `DEC-017` (Constrained) | Nutrition dataset (line 1077), Nutrition schema and units (line 1334) |
| `STB-05` - Preserve explicit zero nutrition values | 2. Existing-feature stabilisation | Complete (2026-08-13) | `STB-04` | `STB-06` | - | Nutrition schema and units (line 1334) |
...
| `STB-07` - Isolate and harden OpenFoodFacts access | 2. Existing-feature stabilisation | Complete (2026-08-13) | `FND-09` | `STB-08`, `NUT-06` | - | Current rules and constraints (line 1176) |
...
| `REC-04` - Build the draft recipe editor | 3. Core recipe functionality | Complete (2026-08-15) | `REC-01`, `REC-02`, `REC-03` | `REC-05`, `REC-15`, `UX-03` | - | Recipe draft (line 186), Recipe imports (line 1454) |
| `REC-05` - Finalize and publish a recipe draft | 3. Core recipe functionality | Complete (2026-08-15) | `REC-04`, `FND-05` | `REC-06`, `REC-07`, `NUT-15`, `PLAN-01` | - | Finalized recipe version (line 272), Recipe imports (line 1454) |
...
| `REC-15` - Import pasted recipe text into a draft | 3. Core recipe functionality | Complete (2026-08-27) | `REC-04`, `FND-09`, `DEP-04`, `DEP-05` | `REC-16`, `REC-17`, `NUT-17`, `UX-06` | `DEC-005` (Constrained), `DEC-007` (Constrained) | Recipe imports (line 1454) |
| `REC-16` - Import a webpage recipe into a draft | 3. Core recipe functionality | Complete (2026-08-27) | `REC-15`, `FND-09`, `DEP-04`, `DEP-05` | - | `DEC-005` (Unblocked), `DEC-007` (Unblocked) | Recipe imports (line 1454) |
...
| `NUT-10` - Add catalogue correction proposals | 4. Nutrition and food matching | Complete (2026-09-09) | `NUT-09` | `NUT-18` | `DEC-009` (Constrained), `DEC-010` (Constrained), `DEC-013` (Constrained) | NUT-10 catalogue correction proposal (line 1586) |
...
| `NUT-15` - Calculate recipe nutrition estimates | 4. Nutrition and food matching | Complete (2026-09-11) | `REC-05`, `NUT-05`, `NUT-12`, `NUT-14` | `NUT-16`, `NUT-17`, `PLAN-03` | `DEC-001` (Constrained), `DEC-003` (Constrained) | Recipe nutrition sources and overrides (line 1402) |
...
| `NUT-17` - Add recipe nutrition source precedence and overrides | 4. Nutrition and food matching | Complete (2026-09-12) | `NUT-15`, `FND-05`, `REC-15` | `NUT-18`, `PLAN-06` | `DEC-003` (Constrained) | Recipe nutrition sources and overrides (line 1402) |
| `NUT-18` - Recalculate affected recipes after catalogue approval | 4. Nutrition and food matching | Complete (2026-09-12) | `NUT-10` or `NUT-11`, `NUT-17`, `FND-09`, `DEP-04`, `DEP-05` | - | - | Recipe nutrition sources and overrides (line 1402) |
...
| `DEC-003` - Nutrient storage precision | Decided | `FND-06` (Unblocked), `STB-04` (Constrained), `STB-06` (Unblocked), `NUT-05` (Unblocked), `NUT-15` (Constrained), `NUT-17` (Constrained) | Catalogue nutrition observation and normalized fact (line 775), Nutrient definition (line 1058), Current rules and constraints (line 1176), Nutrition schema and units (line 1334) |
| `DEC-004` - Nutrient display precision | Decided | `FND-06` (Unblocked), `STB-06` (Unblocked), `NUT-05` (Related), `NUT-16` (Constrained), `PLAN-12` (Constrained), `UX-04` (Constrained) | Catalogue nutrition observation and normalized fact (line 775), Nutrient definition (line 1058), Nutrition dataset (line 1077), Current rules and constraints (line 1176) |
| `DEC-005` - Recipe-import providers and formats | Decided | `FND-09` (Related), `REC-15` (Constrained), `REC-16` (Unblocked), `REC-17` (Constrained), `UX-06` (Related), `DEP-02` (Unblocked), `DEP-03` (Constrained) | Recipe imports (line 1454) |
| `DEC-006` - OCR providers and formats | Decided | `FND-09` (Constrained), `REC-17` (Unblocked), `UX-06` (Constrained), `DEP-02` (Unblocked), `DEP-03` (Constrained), `DEP-04` (Related), `DEP-05` (Related) | Recipe imports (line 1454) |
| `DEC-007` - Import and OCR extraction-quality thresholds | Decided | `FND-09` (Related), `REC-15` (Constrained), `REC-16` (Unblocked), `REC-17` (Unblocked), `UX-06` (Constrained), `DEP-04` (Related), `DEP-05` (Related) | Recipe imports (line 1454) |
...
| `DEC-011` - Manual-food de-duplication and merge rules | Decided | `FND-02` (Related), `NUT-02` (Constrained), `NUT-03` (Related), `NUT-08` (Unblocked), `NUT-09` (Constrained) | Legacy ingredient catalogue mapping (line 903), NUT-09 catalogue moderation records (line 1551) |
...
| Current relationships | 1136-1175 | - | - |
| Current rules and constraints | 1176-1280 | `FND-06`, `STB-07` | `DEC-003`, `DEC-004` |
| Unclear or inconsistent concepts | 1281-1282 | - | - |
| Concept: Meaning of ingredient | 1283-1289 | - | - |
| Concept: Meaning of quantity | 1290-1302 | - | - |
| Concept: Serving terminology | 1303-1314 | - | - |
| Concept: Food identity and barcode uniqueness | 1315-1321 | - | - |
| Concept: Nutrition provenance and accuracy | 1322-1333 | - | - |
| Concept: Nutrition schema and units | 1334-1351 | `STB-04`, `FND-06`, `STB-05` | `DEC-003` |
| Concept: Keywords and categories | 1352-1359 | - | - |
| Concept: Original user input | 1360-1372 | - | - |
| Concept: Public recipe metadata | 1373-1401 | - | - |
| Concept: Recipe nutrition sources and overrides | 1402-1442 | `NUT-15`, `FND-05`, `NUT-18`, `NUT-17` | - |
| Concepts not yet represented | 1443-1453 | - | - |
| Concept: Recipe imports | 1454-1532 | `REC-15`, `REC-16`, `REC-04`, `REC-05` | `DEC-006`, `DEC-005`, `DEC-007` |
| Questions requiring owner input | 1533-1550 | - | - |
| NUT-09 catalogue moderation records | 1551-1585 | `NUT-09`, `FND-05` | `DEC-011` |
| NUT-10 catalogue correction proposal | 1586-1609 | `NUT-10` | - |
