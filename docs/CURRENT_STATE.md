...
| Meal planning | Owned reusable or dated plans, days/slots, pinned recipe/catalogue/one-off entries, consumption snapshots, recipe-version review, selected-user read-only shares, fail-closed public sharing, private public-plan bookmarks, independent private copies, and private daily nutrition-target profiles | meal-plan and nutrition-target controllers and domain services | PLAN-01 through PLAN-10; ownership and visibility in [authorization and privacy matrix](AUTHORIZATION_PRIVACY_MATRIX.md) |
