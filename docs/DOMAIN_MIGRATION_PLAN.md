...
| De-duplication | NUT-02 reports duplicate barcode evidence but implements no manual duplicate workflow. | DEC-011 now permits advisory candidates and authorized reviewed merges only. NUT-02 remains unchanged; NUT-08/NUT-09 must retain identities, provenance and history. |
