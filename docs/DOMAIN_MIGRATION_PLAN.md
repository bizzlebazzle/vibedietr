...
| DEC-009 — Initial administrator assignment | Decided. Its resolution enabled FND-04 administrator persistence and central authorization. Operational bootstrap and lifecycle remain assigned to FND-14 and cannot be relied on until that work and its dependencies are complete. |
