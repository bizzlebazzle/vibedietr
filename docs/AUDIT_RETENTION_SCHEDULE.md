...
| Recipe versions, overrides, nutrition calculations, remix lineage, sharing, and publication | Current for revision, override, recalculation, remix, visibility, and publication history; sharing remains planned | Product history; restoration; public-content provenance | Recipe owner/system; recipe/version/calculation/lineage resource | Domain version references, action, visibility state, timestamp, outcome. Do not copy recipe bodies, ingredient text, or nutrition payloads into audit | Private history has no protected audit value after purge. Anonymous public lineage can remain useful | DEC-012, DEC-013; REC and NUT roadmap items, DEP-08 |
| Meal plans, targets, consumption, snapshots, sharing, bookmarks, and copies | Current PLAN-05 consumption-transition and PLAN-07 recipe-version review history; other listed workflows remain planned | Product history; stable snapshots; user-visible history; public-content provenance | Plan owner/system; plan/version/snapshot/copy resource | Domain version references, action, visibility, timestamp, outcome. No plan, target, diary, or health-revealing content in audit | Private history is deleted at purge. Approved anonymous public/copy provenance can remain useful | DEC-012, DEC-013, DEC-014; PLAN roadmap items, DEP-08 |
| Import and OCR processing | Current; upload, processing attempt, success/failure, abandonment, cleanup | Operational troubleshooting; user-visible import status; verified transient deletion | Importing user/job; opaque import/draft resource | Processor/version, safe event/outcome/error class, timestamps and correlation ID. No source bytes, extracted/OCR text, user filename, storage path, provider payload or private recipe content | Minimized processing metadata has short-lived troubleshooting value; deletion outcome verifies cleanup without retaining the resource | DEC-005 through DEC-007, DEC-012, DEC-013; FND-09, REC-15 through REC-17 |
