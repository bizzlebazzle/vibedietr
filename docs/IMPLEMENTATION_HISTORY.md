...
This file preserves the cumulative implementation narrative formerly held in
`CURRENT_STATE.md`, through application baseline
`bab994f90b8532603d13514459da6f00b4972025` (2026-09-10).

It is lookup-only historical implementation evidence. Sections were written at
different roadmap milestones, so an earlier phase-boundary statement may be
superseded by a later section. Start with [Current state](CURRENT_STATE.md) for
the present architecture and capability index, then read only the relevant
