...
return [
    ...
    'ocr' => [
        ...
        'tesseract_executable' => env('OCR_TESSERACT_EXECUTABLE', '/usr/bin/tesseract'),
        'tesseract_version' => env('OCR_TESSERACT_VERSION'),
        'traineddata_path' => env('OCR_TESSERACT_DATA_PATH', '/usr/share/tesseract-ocr/5/tessdata/eng.traineddata'),
        'traineddata_sha256' => env('OCR_TESSERACT_DATA_SHA256'),
        ...
        'max_output_bytes' => (int) env('OCR_MAX_OUTPUT_BYTES', 8388608),
        'abandoned_days' => (int) env('OCR_ABANDONED_DAYS', 7),
        ...
        'google' => [
            ...
            'attempts' => (int) env('OCR_GOOGLE_ATTEMPTS', 2),
            'concurrency' => (int) env('OCR_GOOGLE_CONCURRENCY', 1),
            'monthly_budget_minor' => (int) env('OCR_GOOGLE_MONTHLY_BUDGET_MINOR', 0),
            'page_cost_minor' => (int) env('OCR_GOOGLE_PAGE_COST_MINOR', 0),
        ],
    ],
];
